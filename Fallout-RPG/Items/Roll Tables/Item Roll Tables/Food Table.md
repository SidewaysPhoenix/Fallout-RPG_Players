...
const STORAGE_KEY = 'fallout_food_filter_inputs';
const TABLE_KEY = 'fallout_food_table_results';
...
const folderPath = "Fallout-RPG/Items/Consumables/Food";
...
const renderTable = (data) => {
    ...
    if (data.length === 0) {
        resultsContainer.textContent = "No food match the selected filters.";
